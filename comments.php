...
<div id="comments" class="comments-area">
	<h5 class="comments-title"><?php echo get_comments_number(); ?> 
		...
		<?php if (is_user_logged_in() && current_user_can('edit_posts')): echo '| <a href="' . get_edit_post_link() . '">/ Edit Post</a>'; endif; ?> 
		...
		?>
					...
					<div class="add_comment_link"><a href="<?php comments_link(); ?>">Add Comment</a></div>	
		</h5>
	</div>
	...
	<a href="#AddComment" class="add-comment"><?php /* echo strtoupper('Leave a comment'); */ ?></a>		
	<?php comment_form(); ?>
